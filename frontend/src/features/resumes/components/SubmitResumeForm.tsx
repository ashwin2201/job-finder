...
const SubmitResumeForm = () => {
    ...
    const showJobListings = async (values: z.infer<typeof formSchema>) => {
        const formData = {
            ...
            first_name_kana: values.firstName || null,
            last_name_kana: values.lastName || null,
    ...
    return (
        <div className="max-w-2xl mx-auto p-6 bg-white shadow-md rounded-lg">
            ...
            <Form {...form}>
                ...
                <Button type="button" onClick={form.handleSubmit(generateResume)}>Generate Resume</Button>
...
export default SubmitResumeForm
