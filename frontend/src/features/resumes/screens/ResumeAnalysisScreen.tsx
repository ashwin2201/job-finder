...
const SectionCard = ({
  ...
  <section className={`${appTheme.panel} rounded-[28px] bg-white p-5 sm:p-6`}>
  ...
  return (
    <div className="overflow-y-auto">
      <main className="min-h-screen bg-secondary/40">
        <PageHeader eyebrow="Resume lab" title="Resume analysis" />

        <div className="px-4 py-6 sm:px-6">
          <div className="mx-auto max-w-[1480px]">
            <div className="grid gap-6 xl:grid-cols-[minmax(0,1.45fr)_minmax(360px,0.9fr)]">
              <section className="space-y-6">
                <div className={`${appTheme.panel} rounded-[30px] bg-white p-6 sm:p-7`}>
                  <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      <Button className={`h-11 rounded-[18px] px-4 ${appTheme.button}`}>
                ...
                <section className={`${appTheme.panel} rounded-[30px] bg-white p-6 sm:p-7`}>
                ...
                <section className={`${appTheme.panel} rounded-[28px] bg-[linear-gradient(135deg,#fff9f6,#fff2ef)] p-5 sm:p-6`}>
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <Button className={`h-11 rounded-[18px] px-5 ${appTheme.button}`}>
                      Improve with AI
              ...
              <aside className="space-y-4">
                <div className={`${appTheme.panel} rounded-[30px] bg-white p-4 sm:p-5`}>
