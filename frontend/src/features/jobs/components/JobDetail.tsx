...
const JobDetail = ({ job, badges, onBack }: JobDetailProps) => {
  ...
  return (
    <div className={`${appTheme.panel} rounded-[24px] p-6`}>
      <div className="space-y-5">
        ...
        <div className="space-y-3">
          <h2 className={`text-3xl font-semibold ${appTheme.title}`}>{job.title}</h2>
        ...
        <div className="rounded-[24px] border border-border bg-card p-5 shadow-none">
          <h3 className={`text-lg font-semibold ${appTheme.title}`}>Role overview</h3>
